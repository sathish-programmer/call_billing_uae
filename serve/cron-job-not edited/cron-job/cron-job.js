...
var calculateCallType = new CronJob('*/2 * * * *', async function () {
  ...
  var callLogs = await CALL_LOGS.find({ "callTypeCalculated": false }, "",
    { "limit": 5000, "sort": { "creationDate": -1 } }).lean();
  ...
  if (callLogs && callLogs.length) {
    ...
    for (var callLogIndex in callLogs) {
      ...
      // VOICE MAIL
      if ((singleCallLog['Party2Device'] && singleCallLog['Party2Device'] == 'VM')
        || (singleCallLog['Party2Device'] && singleCallLog['Party2Device'].indexOf('V95') == 0)
        || (singleCallLog['ExternalTargetingCause'] && singleCallLog['ExternalTargetingCause'].indexOf('VM Channel') == 0)) {
        type.push('voicemail');
      }

      // CONFERENCE CALL
      if (singleCallLog['Party2Name'] && singleCallLog['Party2Name'].indexOf('CO Channel') == 0) {
      ...
      // MISSED call
      if ((singleCallLog['Direction'] && singleCallLog['Direction'] == 'I') && singleCallLog['CallDuration'] == 0) {
        type.push('missed');
      }

      //Internal call
      if (((singleCallLog['IsInternal'] && singleCallLog['IsInternal'] == '1')
        && (singleCallLog['Direction'] && singleCallLog['Direction'] == 'O')
        && (singleCallLog['Callernumber'] && String(singleCallLog['Callernumber']).length >= 3 && String(singleCallLog['Callernumber']).length <= 5)
        && (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].length >= 3 && singleCallLog['Callednumber'].length <= 5))
        || (singleCallLog['Direction'] && singleCallLog['Direction'] == '0')) {
        type.push('internal');
      }

      //Service call
      if ((singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('500') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('600') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('700') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('800') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('900') == 0)) {
        type.push('service');
      }

        //local call
        if ((singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('04') == 0)) {
          type.push('local');
        }


        if ((singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('04') == 0 && singleCallLog['Callernumber'].length==9 )) {
          type.push('local');
        }
        if ((singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('4') == 0 && singleCallLog['Callernumber'].length==8 )) {
          type.push('local');
        }
        //National
        
        if ( (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('02') == 0 && singleCallLog['Callernumber'].length==9)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('03') == 0 && singleCallLog['Callernumber'].length==9)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('06') == 0 && singleCallLog['Callernumber'].length==9)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('07') == 0 && singleCallLog['Callernumber'].length==9)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('08') == 0 && singleCallLog['Callernumber'].length==9)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('09') == 0 && singleCallLog['Callernumber'].length==9)){
          type.push('national');
        }

        if ( (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('2') == 0 && singleCallLog['Callernumber'].length==8)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('3') == 0 && singleCallLog['Callernumber'].length==8)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('6') == 0 && singleCallLog['Callernumber'].length==8)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('7') == 0 && singleCallLog['Callernumber'].length==8)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('8') == 0 && singleCallLog['Callernumber'].length==8)
        || (singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('9') == 0 && singleCallLog['Callernumber'].length==8)){
          type.push('national');
        }

        if ( (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('02') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('03') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('06') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('07') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('08') == 0)
        || (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('09') == 0)){
          type.push('national');
        }

          //Mobile call
          if ((singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('05') == 0)) {
            type.push('mobile');
          }

          // mobile bangalore call
          if ((singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('80') == 0)) {
            type.push('mobile');
          }

          if ((singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('5') == 0 && singleCallLog['Callernumber'].length == 9 )) {
            type.push('mobile');
          }

          if ((singleCallLog['Callernumber'] && singleCallLog['Callernumber'].indexOf('05') == 0 && singleCallLog['Callernumber'].length == 10 )) {
            type.push('mobile');
          }

      //International Call
      if (singleCallLog['Callednumber'] && singleCallLog['Callednumber'].indexOf('00') == 0) {
...

      {
        ...
        let tariffsPerOrg = _.difference(tariffDetails.filter(td => {
          if ((String(td.organization) == String(singleCallLog['organization']))
        ...
        let retDoc = tariffsPerOrg.filter(stpo => {
          if (singleCallLog[lookInto] && singleCallLog[lookInto].indexOf(stpo.countryCode) == 0) {
            return stpo;
          }
        });
        ...
        if (retDoc && retDoc.length) {
          let allTypes = _.difference(_.pluck(retDoc, "callType"), [undefined, null, '']);
          type = [...type, ...allTypes];
        }
      }
      ...
      if (type && type.length) {
        ...
        await CALL_LOGS.update({ _id: callLogs[callLogIndex]['_id'] },
...
var calculateCallCostJob = new CronJob("*/2 * * * *", async function () {
  ...
  let callLogs = await CALL_LOGS.find({ "callCostCalculated": false, "Direction": "O" },
  ...
  if (callLogs && callLogs.length) {
    ...
    for (let index in callLogs) {
      ...
      let oneCycle = 60, cost = 0, totalCycles = 0;

      if (callLogs[index]['Callednumber'] && tariffsPerOrg && tariffsPerOrg.length) {
        ...
        if (CallednumberLength > 10) {
          ...
          code = number.substring(0, 3);
          if(code=='500' ||code=='600' || code=='700' || code=='800' ||code=='181'){
          costCycleJson = _.findWhere(tariffsPerOrg, { countryCode: code });
          }
          ...
          if (!costCycleJson) {
            ...
            if(code=='05' ||code=='04' || code=='02' || code=='06' || code=='09' || code=='07' || code=='03' || code=='08'){
            costCycleJson = _.findWhere(tariffsPerOrg, { countryCode: code });
            }
        ...
        if (costCycleJson) {
          ...
          oneCycle = parseInt(costCycleJson['units']) * (parseInt(costCycleJson['unitsMeasurement']));
        }
        ...
        await CALL_LOGS.findByIdAndUpdate({ _id: callLogs[index]['_id'] },
          {
            "$set": {
...
var findBranchInfoForCallLog = new CronJob("*/2 * * * *", async function () {
  ...
  let callLogs = await CALL_LOGS.find({ "branchCalculated": false },
  ...
  try {
    if (callLogs && callLogs.length) {
      ...
      for (let kI in keys) {
        ...
        {
          extensions = _.union(_.pluck(callLogs, "Callernumber"),
            _.pluck(callLogs, "Callednumber"),
            _.pluck(callLogs, "DialedNumber"));
          extensions = _.uniq(_.difference(_.map(extensions, function (se) {
            se = String(se);
        ...
        // Tie branch with call log
        {
          ...
          for (let index in callLogs) {
            updateData = {};
            let number, foundBranchDetail = {};

            if (callLogs[index]['Direction'] == 'I') {
              number = String(callLogs[index]['Callednumber']);

              if (number.length <= 5) {
                foundBranchDetail = _.findWhere(userDetails, { extension: parseInt(number) });
...
var findDepartmentInfoForCallLog = new CronJob("*/2 * * * *", async function () {
  console.log("Job triggered for finding department call log");
  let callLogs = await CALL_LOGS.find({ "departmentCalculated": false },
    "Callernumber Callednumber DialedNumber organization _id Direction",
    { "limit": 5000, "sort": { "creationDate": -1 } }).lean();
  console.log("cal logs", callLogs.length);
  try {
    if (callLogs && callLogs.length) {
      ...
      for (let kI in keys) {
        ...
        // Tie department with call log
        {
          ...
          for (let index in callLogs) {
            updateData = {};
            let number, foundDepartmentDetail = {};

            if (callLogs[index]['Direction'] == 'I') {
              number = String(callLogs[index]['Callednumber']);

              if (number.length <= 5) {
                foundDepartmentDetail = _.findWhere(userDetails, { extension: parseInt(number) });
...
var findCallerNameInfoForCallLog = new CronJob("*/2 * * * *", async function () {
  let callLogs = await CALL_LOGS.find({ "callerNameCalculated": false }, "Callernumber callerNameCalculated organization",
                                      { "limit": 5000, "sort": { "creationDate": -1 } }).lean();
  ...
  if (callLogs && callLogs.length) {
    ...
    for (let kI in keys) {
      ...
      {
        extensions = _.uniq(_.difference(_.map(_.pluck(callLogs, "Callernumber"), function (se) {
          se = String(se);
      ...
      if (extensions && extensions.length) {
        ...
        userDetails = await USER.find({organization: keys[kI], extension: {"$in": extensions}}, "extension").lean();
      }
      console.log("User details", userDetails);
      {
        let updateData;
        for (let index in callLogs) {
          ...
          if (!callLogs[index]['callerNameCalculated']) {
            ...
            if (callerNumber.length <= 5) {
              callerExtension = _.findWhere(userDetails, {extension: parseInt(callLogs[index]['Callernumber'])});
          ...
          if (updateData && Object.keys(updateData).length) {
            ...
            await CALL_LOGS.findByIdAndUpdate({ _id: callLogs[index]['_id'] }, { "$set": updateData });
          }
...
var findCalledNameInfoForCallLog = new CronJob("*/2 * * * *", async function () {
  let callLogs = await CALL_LOGS.find({ "calledNameCalculated": false }, "Callednumber DialedNumber calledNameCalculated organization",
                                      { "limit": 5000, "sort": { "creationDate": -1 } }).lean();
  ...
  if (callLogs && callLogs.length) {
    ...
    for (let kI in keys) {
      ...
      // Get extensions from call logs
      {
        extensions = _.union(_.pluck(callLogs, "DialedNumber"), _.pluck(callLogs, "Callednumber"));
        extensions = _.uniq(_.difference(_.map(extensions, function (se) {
          se = String(se);
        ...
        for (let index in callLogs) {
          ...
          if (!callLogs[index]['calledNameCalculated']) {
            ...
            if (calledNumber.length <= 5) {
              callerExtension = _.findWhere(userDetails, {extension: parseInt(calledNumber)});
    ...
    for (let retDoc of retDocs) {
      if (retDoc && retDoc.data && retDoc.data.length >=3) {
        ...
        for (let cL of retDoc.data) {
          let number = cL['Party1Device'] ? cL['Party1Device'].substring(1) : '';
          ...
          if (number !== cL['Callednumber']) {
            ...
            await CALL_LOGS.findByIdAndUpdate({ _id: cL['_id']}, 
        ...
        if (requiredLog) {
          await CALL_LOGS.findByIdAndUpdate({ _id: requiredLog['_id']}, 
                                            { "$set": {"transferCallCalculated": true, 
