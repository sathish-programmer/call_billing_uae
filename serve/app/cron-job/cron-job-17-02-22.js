...
var calculateCallType = new CronJob("*/2 * * * *", async function () {
  ...
  if (callLogs && callLogs.length) {
    ...
    for (var callLogIndex in callLogs) {
      ...
      if (
        (singleCallLog["ExternalTargetingCause"] &&
          singleCallLog["ExternalTargetingCause"].indexOf("XfP") > 0) ||
        (singleCallLog["ExternalTargetingCause"] &&
          singleCallLog["ExternalTargetingCause"].indexOf("Xfd") > 0) ||
        (singleCallLog["ExternalTargetingCause"] &&
          singleCallLog["ExternalTargetingCause"].indexOf("fb") > 0)
      ) {
        type.push("transfer");
      }
      ...
      // if (
      //   singleCallLog["Callernumber"] &&
      //   singleCallLog["Callernumber"].indexOf("5") == 0 &&
      //   singleCallLog["Callernumber"].length == 9
      // ) {
      //   type.push("mobile");
      // }
      ...
      // if (
      //   singleCallLog["Callernumber"] &&
      //   singleCallLog["Callernumber"].indexOf("05") == 0 &&
...
var findBranchInfoForCallLog = new CronJob("*/2 * * * *", async function () {
  ...
  console.log("chceck branch call log");
  console.log(callLogs);
  // console.log('chceck branch call log')
  try {
    if (callLogs && callLogs.length) {
      console.log("sathish checkning condition");
      ...
      for (let kI in keys) {
        ...
        console.log("user details sathish", userDetails);
