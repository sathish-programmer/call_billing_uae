...
const {
  loginForCallLogs,
  logout,
  loginForCallLogspepperstone,
  logoutpepperstone,
} = require("../auth/auth.controller");
const controller = require("./call-logs.controller");
const {
  checkAuthForCallLogs,
  checkAuth,
  checkAuthForCallLogspepper,
} = require("../middleware");
...
router.post(
  "/list/:orgId/type-wise",
  checkAuth,
  controller.getCallListForDashboard
);
router.post(
  "/list/:orgId/summary",
  checkAuth,
  controller.getCallSummaryForDashboard
);

// del call log
router.get("/log/delete", checkAuth, controller.deleteCallLog);
