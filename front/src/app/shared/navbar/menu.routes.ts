  ...
  paths: function (permissions) {
    return [
      //ADMIN
      {
        product: 'Admin',
        checkpermission:
          permissions.indexOf('canAddOrganization') >= 0 ||
        ...
        actions: [
          ...
          },
          {
            ...
            checkpermission:
              permissions.indexOf('canRetrieveRole') >= 0 ||
              permissions.indexOf('canAddRole') >= 0,
          },
          {
            title: 'Manage Branch',
          ...
          },
          {
            ...
            routerLink: '/admin/sub-department',
            checkpermission:
              permissions.indexOf('canAddSubDepartment') >= 0 ||
      ...
      // INAIPI
      {
        product: 'INAIPI',
        checkpermission:
          permissions.indexOf('canSeeCallLogsDashboard') >= 0 ||
        ...
        actions: [
          {
            title: 'Dashboard',
            routerLink: '/admin/inaipi/dashboard',
            checkpermission:
              permissions.indexOf('canSeeCallLogsDashboard') >= 0,
          },
          {
            title: 'Setup',
            routerLink: '/admin/inaipi/setup',
            checkpermission:
              permissions.indexOf('canAddTariff') >= 0 ||
              permissions.indexOf('canAddProvider') >= 0 ||
              permissions.indexOf('canAddAssignTariff') >= 0,
